...
public class ReviewsPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Review review6 = new Review("Titanic", "/images/titanic.jpg",
				"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sed risusutrum dolor aliquam rhoncus. Donec tempor eros orci, vitae tincidunt exlaoreet quis. Sed et rutrum tellus, a cursus sem.",
				category2, tagPg);
